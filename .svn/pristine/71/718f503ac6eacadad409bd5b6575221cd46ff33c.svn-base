...
//				"http://t.changyou.com:9099/pay/tenpay/payRequest.jsp"
	 ...
	 * @param backInfo
	 */
	private void paySuccess(String backInfo){
		if(backInfo != null && !TextUtils.isEmpty(backInfo)){
			log.d("Tenpay result = "+backInfo);
			Bundle b = new Bundle();
			...
			CYMGPayHelper.getInstance().paySuccess(mUID, mGoodsItem, mOrderID,mActivity);
		}
	}
}
