...
public class CYMGPaymentWayGameCardFragment extends BaseFragment implements OnClickListener{
	...
	private void setPromptTv(int type){
		...
		case WY:
			...
			break;
		case SD:
			this.mPromptTv1.setText(PayResource.getInstance(mActivity).mgp_payment_way_card_prompt2_juncard_tv3_1);
			this.mPromptTv2.setText(PayResource.getInstance(mActivity).mgp_payment_way_card_prompt2_juncard_tv3_2);
			break;
		case WM:
