	...
	class OptionsAdapter extends BaseAdapter {  
	    ...
	    public View getView(final int position, View convertView, ViewGroup parent) {  
	        ...
	        holder.imageView2.setOnClickListener(new View.OnClickListener() {
	            ...
	            public void onClick(View v) {
	                mDelIndex=position;
	                String accFormat=mActivity.getString(AccResource.getInstance(mActivity).mgp_sdk_2_0_switch_account_str_7);
	    			String accString=String.format(accFormat, account.substring(6, account.length()));
	    			mAlertDialog.setMessage(accString);
	            	mAlertDialog.show();
	            }  
	        });  
	        return convertView;   
