...
public class CYMGFlowWinManager {
	 ...
	 * 获取游戏截图的回调
	 */
	private CYMGCaptureHandler mCaptureHandler;
	...
	public void setContext(Context context){
		...
		if(mContext == null){
			...
			mExpandWin = new CYMGFlowWindowExpand(mContext,mCaptureHandler!=null);
			mCloseShown = false;
			mExpandShown = false;
	...
	/**
	 * 在初始化的CYMGPlatforConfig的Builder.setCaptureHandler方法中传进来
	 * 根据mCaptureHandler是否为空判断是否显示截图按钮
	 * @param handler
	 */
	public void setCaptureHandler(CYMGCaptureHandler handler){
		this.mCaptureHandler = handler;
	}
	
	public CYMGCaptureHandler getCaptureHandler(){
