...
public class MGPDropDownListHeaderView extends ViewGroup{
	...
	public MGPDropDownListHeaderView(Context context,MGPDropDownListView listview){
		super(context);
	...
	public void addView(View child) {
		this.mTipsTV = (TextView)child.findViewById(PayResource.getInstance(mContext).pull_fresh_tipstv);
		this.mTipsTV.setText(PayResource.getInstance(mContext).mgp_drop_down_list_header_pull_text);
		this.mTimeTV = (TextView)child.findViewById(PayResource.getInstance(mContext).pull_fresh_timetv);
		this.mArrowIV = (ImageView)child.findViewById(PayResource.getInstance(mContext).pull_fresh_arrowiv);
		this.mPB = (ProgressBar)child.findViewById(PayResource.getInstance(mContext).pull_fresh_pb);
		super.addView(child);
	}
...
//		Log.d("pengyou", mTipsTV.getText().toString());
	...
	private void onViewChanged(){
		if(mCanUpdate){
	        ...
	        mTipsTV.setText(mContext.getString(PayResource.getInstance(mContext).mgp_drop_down_list_header_release_text));
		}else{
			mArrowIV.clearAnimation();
	        mArrowIV.startAnimation(mAnimationDown);
	        mTipsTV.setText(mContext.getString(PayResource.getInstance(mContext).mgp_drop_down_list_header_pull_text));
		}
	}
...
//		}
	...
	private void onViewUpdating(){
        ...
        this.mTipsTV.setText(PayResource.getInstance(mContext).mgp_drop_down_list_header_loading_text);
	}
...
//        e.commit();
	...
	public void setActivity(Activity activity){
		...
		if(this.mTimeTV != null){
			this.mTimeTV.setText(mContext.getString(PayResource.getInstance(mContext).mgp_pull_to_refresh_update_time
